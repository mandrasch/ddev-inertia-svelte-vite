...
/* resources/js/Pages/Welcome.svelte generated by Svelte v3.46.6 */
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      p.textContent = "Hello ".concat(user, ", welcome to your first Inertia app!");
...
var map = {
	"./Welcome.svelte": "./resources/js/Pages/Welcome.svelte"
};
